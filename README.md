...
# В выводе будет показан сгенерированный ключ:
...
### Пример 2: Базовое шифрование и дешифрование
...
CryptoCore включает комплексную систему тестирования для обеспечения надежности и криптографической стойкости:
